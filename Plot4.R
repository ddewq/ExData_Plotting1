...
# Create PNG and plot 4 different plots onto one
png(filename="Plot4.png", width=480, height=480, units = "px") 

par(mfrow = c(2, 2), mar = c(4, 4, 2, 1), oma = c(0, 0, 2, 0))
with(sData, plot(x, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))
with(sData, plot(x, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))
...
with(sData, plot(x, Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power"))
